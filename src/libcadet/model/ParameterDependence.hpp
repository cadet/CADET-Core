...
public:
	 ...
	 */
	virtual bool configure(IParameterProvider& paramProvider, UnitOpIdx unitOpIdx, ParticleTypeIdx parTypeIdx,
						   BoundStateIdx bndIdx, const std::string& name) = 0;
	 ...
	 * inner center = 0)
	 * @param [in] comp Index of the component the parameter belongs to (or @c -1 if independent of components)
	 * @param [in] parType Index of the particle type the parameter belongs to (or @c -1 if independent of particle
	 * types)
	 * @param [in] bnd Index of the bound state the parameter belongs to (or @c -1 if independent of bound states)
	 * @return Actual parameter value
	 */
	virtual double getValue(const IModel& model, const ColumnPosition& colPos, int comp, int parType,
							int bnd) const = 0;
	 ...
	 * @return Actual parameter value
	 */
	virtual active getValueActive(const IModel& model, const ColumnPosition& colPos, int comp, int parType,
								  int bnd) const = 0;
	 ...
	 * @return Actual parameter value
	 */
	virtual double getValue(const IModel& model, const ColumnPosition& colPos, int comp, int parType, int bnd,
							double val) const = 0;
	 ...
	 * @return Actual parameter value
	 */
	virtual active getValue(const IModel& model, const ColumnPosition& colPos, int comp, int parType, int bnd,
							const active& val) const = 0;
