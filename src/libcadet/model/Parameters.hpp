...
public:
							  ...
							  unsigned int const* nBoundStates)
	{
		...
		registerParam2DArray(
			parameters, *_p,
			[=](bool multi, unsigned r, unsigned int c) {
				return makeParamId(nameHash, unitOpIdx, c, parTypeIdx, BoundStateIndep, r, SectionIndep);
			},
			nComp);
	}
	...
	inline typename std::vector<active>::size_type size() const CADET_NOEXCEPT
	{
		return _p->size();
	}
...
public:
							  ...
							  unsigned int const* nBoundStates)
	{
		...
		registerParam2DArray(
			parameters, _base,
			[=](bool multi, unsigned int r, unsigned c) {
				return makeParamId(hashConst, unitOpIdx, c, parTypeIdx, BoundStateIndep, r, SectionIndep);
			},
			nComp);
		...
		registerParam2DArray(
			parameters, _linear,
			[=](bool multi, unsigned int r, unsigned c) {
				return makeParamId(hashLinear, unitOpIdx, c, parTypeIdx, BoundStateIndep, r, SectionIndep);
			},
			nComp);
		...
		registerParam2DArray(
			parameters, _quad,
			[=](bool multi, unsigned int r, unsigned c) {
				return makeParamId(hashQuad, unitOpIdx, c, parTypeIdx, BoundStateIndep, r, SectionIndep);
			},
			nComp);
		...
		registerParam2DArray(
			parameters, _cube,
			[=](bool multi, unsigned int r, unsigned c) {
				return makeParamId(hashCube, unitOpIdx, c, parTypeIdx, BoundStateIndep, r, SectionIndep);
			},
			nComp);
	}
