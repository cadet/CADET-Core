...
/* For particle type specific particle models: only read/register one particle type */
	 ...
	 * @param [out] values Array to store the read parameters in
	 * @param [in] name Name of the parameter
	 * @param [in] nTotalBound Number of total bound states in all particle types combined
	 * @param [in] nComp Number of components
	 ...
	 * @return Inferred or read multiplexing mode
	 */
	MultiplexMode readAndRegisterSingleTypeMultiplexBndCompTypeSecParam(IParameterProvider& paramProvider, std::unordered_map<ParameterId, active*>& parameters, std::vector<active>& values, const std::string& name,
		unsigned int nTotalBound, unsigned int nComp, unsigned strideBound, unsigned int const* nBound, unsigned int const* nBoundBeforeType, const unsigned int parTypeIdx, UnitOpIdx uoi);
	 ...
	 * @return @c true if the value has been applied, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexTypeParameterValue(const ParameterId& pId, StringHash nameHash, bool mode, active& data, unsigned int parTypeIdx, double value, std::unordered_set<active*> const* sensParams);
	 ...
	 * @return @c true if the parameter has been found, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexTypeParameterAD(const ParameterId& pId, StringHash nameHash, bool mode, active& data, unsigned int parTypeIdx, unsigned int adDirection, double adValue, std::unordered_set<active*>& sensParams);
	 ...
	 * @return Inferred or read multiplexing mode
	 */
	MultiplexMode newIF_readAndRegisterSingleTypeMultiplexCompTypeSecParam(IParameterProvider& paramProvider, std::unordered_map<ParameterId, active*>& parameters, std::vector<active>& values, const std::string& name, unsigned int nParType, unsigned int nComp, unsigned int parTypeIdx, UnitOpIdx uoi);
	 ...
	 * @return @c true if the value has been applied, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexCompTypeSecParameterValue(const ParameterId& pId, StringHash nameHash, MultiplexMode mode, std::vector<active>& data, unsigned int nComp, unsigned int parTypeIdx, double value, std::unordered_set<active*> const* sensParams);
	 ...
	 * @return @c true if the parameter has been found, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexCompTypeSecParameterAD(const ParameterId& pId, StringHash nameHash, MultiplexMode mode, std::vector<active>& data, unsigned int nComp, unsigned int parTypeIdx, unsigned int adDirection, double adValue, std::unordered_set<active*>& sensParams);
	 ...
	 * @return Inferred or read multiplexing mode
	 */
	MultiplexMode newIF_readAndRegisterSingleTypeMultiplexBndCompTypeSecParam(IParameterProvider& paramProvider, std::unordered_map<ParameterId, active*>& parameters, std::vector<active>& values, const std::string& name,
		unsigned int nTotalBound, unsigned int nComp, unsigned strideBound, unsigned int const* nBound, unsigned int const* nBoundBeforeType, const unsigned int parTypeIdx, UnitOpIdx uoi);
	 ...
	 * @return @c true if the value has been applied, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexBndCompTypeSecParameterValue(const ParameterId& pId, StringHash nameHash, MultiplexMode mode, std::vector<active>& data,
		unsigned int nComp, unsigned int strideBound, unsigned int const* boundOffset, unsigned int parTypeIdx, double value, std::unordered_set<active*> const* sensParams);
	 ...
	 * @return @c true if the parameter has been found, or @c false otherwise
	 */
	bool newIF_singleTypeMultiplexBndCompTypeSecParameterAD(const ParameterId& pId, StringHash nameHash, MultiplexMode mode, std::vector<active>& data,
		unsigned int nComp, unsigned int strideBound, unsigned int const* boundOffset, unsigned int parTypeIdx, unsigned int adDirection, double adValue, std::unordered_set<active*>& sensParams);
