...
#define CADET_DYNAMICREACTIONMODEL_BOILERPLATE                                                                                 \
	virtual int residualLiquidAdd(const active& t, unsigned int secIdx, const ColumnPosition& colPos, active const* y,         \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualLiquidImpl<active, active, active>(t, secIdx, colPos, y, res, factor, workSpace);                       \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualLiquidAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, active const* y,                \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualLiquidImpl<active, active, double>(t, secIdx, colPos, y, res, factor, workSpace);                       \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualLiquidAdd(const active& t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,         \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualLiquidImpl<double, active, active>(t, secIdx, colPos, y, res, factor, workSpace);                       \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualLiquidAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,                \
		double* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualLiquidImpl<double, double, double>(t, secIdx, colPos, y, res, factor, workSpace);                       \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualCombinedAdd(const active& t, unsigned int secIdx, const ColumnPosition& colPos, active const* y,       \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualCombinedImpl<active, active, active>(t, secIdx, colPos, y, res, factor, workSpace);                     \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualCombinedAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, active const* y,              \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualCombinedImpl<active, active, double>(t, secIdx, colPos, y, res, factor, workSpace);                     \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualCombinedAdd(const active& t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,       \
		active* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualCombinedImpl<double, active, active>(t, secIdx, colPos, y, res, factor, workSpace);                     \
	}                                                                                                                          \
	                                                                                                                           \
	virtual int residualCombinedAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,              \
		double* res, double factor, void* workSpace) const                                                                     \
	{                                                                                                                          \
		return residualCombinedImpl<double, double, double>(t, secIdx, colPos, y, res, factor, workSpace);                     \
	}                                                                                                                          \
	                                                                                                                           \
	virtual void analyticJacobianLiquidAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,       \
		double factor, linalg::BandMatrix::RowIterator jac, void* workSpace) const                                             \
	{                                                                                                                          \
		jacobianLiquidImpl(t, secIdx, colPos, y, factor, jac, workSpace);                                                      \
	}                                                                                                                          \
	                                                                                                                           \
	virtual void analyticJacobianLiquidAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,       \
		double factor, linalg::DenseBandedRowIterator jac, void* workSpace) const                                              \
	{                                                                                                                          \
		jacobianLiquidImpl(t, secIdx, colPos, y, factor, jac, workSpace);                                                      \
	}                                                                                                                          \
	                                                                                                                           \
	virtual void analyticJacobianCombinedAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,     \
		double factor, linalg::BandMatrix::RowIterator jac, void* workSpace) const                                             \
	{                                                                                                                          \
		jacobianCombinedImpl(t, secIdx, colPos, y, factor, jac, workSpace);                                                    \
	}                                                                                                                          \
	                                                                                                                           \
	virtual void analyticJacobianCombinedAdd(double t, unsigned int secIdx, const ColumnPosition& colPos, double const* y,     \
		double factor, linalg::DenseBandedRowIterator jac, void* workSpace) const                                              \
