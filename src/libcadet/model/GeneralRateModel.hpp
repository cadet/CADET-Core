...
namespace
{
template <typename Operator> struct GeneralRateModelName
{
};

template <> struct GeneralRateModelName<cadet::model::parts::AxialConvectionDispersionOperator>
{
	static const char* identifier() CADET_NOEXCEPT
	{
		return "GENERAL_RATE_MODEL";
	}
};

template <> struct GeneralRateModelName<cadet::model::parts::RadialConvectionDispersionOperator>
{
	static const char* identifier() CADET_NOEXCEPT
	{
		return "RADIAL_GENERAL_RATE_MODEL";
	}
};
} // namespace
 ...
 */
template <typename ConvDispOperator> class GeneralRateModel : public UnitOperationBase
{
public:
	...
	{
		return GeneralRateModelName<ConvDispOperator>::identifier();
	}
...
protected:
	...
	template <typename Op_t> friend int schurComplementMultiplierGRM(void* userData, double const* x, double* z);
