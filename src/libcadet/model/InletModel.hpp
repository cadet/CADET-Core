...
public:
	...
	virtual double const* const getData() const CADET_NOEXCEPT { return _inletConcentrationsRaw; }
	virtual active const* const getDataActive() const CADET_NOEXCEPT { return _inletConcentrations; }
