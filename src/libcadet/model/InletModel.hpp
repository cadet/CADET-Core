...
protected:
	...
	int residualImpl(const ParamType& t, unsigned int secIdx, const ParamType& timeFactor, const ConstSimulationState& simState, ResidualType* const res, util::ThreadLocalStorage& threadLocalMem);
