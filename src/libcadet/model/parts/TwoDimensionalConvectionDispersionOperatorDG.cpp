...
{
	for (unsigned int compartment = 0; compartment < _radNElem; ++compartment)
		_curVelocity[compartment] = in[compartment] / (_elementCrossSections[compartment] * _colPorosities[compartment]);
}
