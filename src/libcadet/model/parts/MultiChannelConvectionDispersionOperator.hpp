...
public:
	...
	bool configureModelDiscretization(IParameterProvider& paramProvider, const IConfigHelper& helper,
									  unsigned int nComp, unsigned int nCol, unsigned int nRad, bool dynamicReactions);
	...
	{
		return _nComp * _nCol * _nChannel;
	} // todo compressed AD Jacobian (currently AD is dense for MCT)
