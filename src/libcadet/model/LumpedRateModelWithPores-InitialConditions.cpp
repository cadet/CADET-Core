...
int LumpedRateModelWithPores<ConvDispOperator>::multiplexInitialConditions(const cadet::ParameterId& pId,
...
template <typename ConvDispOperator>
int LumpedRateModelWithPores<ConvDispOperator>::multiplexInitialConditions(const cadet::ParameterId& pId, double val,
																		   bool checkSens)
{
	if (_singleBinding)
	{
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::consistentInitialState(const SimulationTime& simTime,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::consistentInitialTimeDerivative(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::leanConsistentInitialState(const SimulationTime& simTime,
																			double* const vecStateY,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::leanConsistentInitialTimeDerivative(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::consistentInitialSensitivity(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithPores<ConvDispOperator>::leanConsistentInitialSensitivity(
	const SimulationTime& simTime, const ConstSimulationState& simState, std::vector<double*>& vecSensY,
	std::vector<double*>& vecSensYdot, active const* const adRes, util::ThreadLocalStorage& threadLocalMem)
{
	BENCH_SCOPE(_timerConsistentInit);
