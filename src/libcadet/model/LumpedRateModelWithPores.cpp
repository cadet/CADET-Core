...
LumpedRateModelWithPores::LumpedRateModelWithPores(UnitOpIdx unitOpIdx) : _unitOpIdx(unitOpIdx), _binding(nullptr),
...
std::unordered_map<ParameterId, double> LumpedRateModelWithPores::getAllParameterValues() const
{
...
bool LumpedRateModelWithPores::hasParameter(const ParameterId& pId) const
{
...
bool LumpedRateModelWithPores::setParameter(const ParameterId& pId, int value)
{
...
bool LumpedRateModelWithPores::setParameter(const ParameterId& pId, bool value)
{
	if ((pId.unitOperation != _unitOpIdx) && (pId.unitOperation != UnitOpIndep))
		return false;
...
void LumpedRateModelWithPores::clearSensParams()
{
