...
namespace
{
template <typename Operator> struct LumpedRateModelWithoutPoresName
{
};

template <> struct LumpedRateModelWithoutPoresName<cadet::model::parts::AxialConvectionDispersionOperatorBase>
{
...
template <> struct LumpedRateModelWithoutPoresName<cadet::model::parts::RadialConvectionDispersionOperatorBase>
{
	static const char* identifier() CADET_NOEXCEPT
	{
		return "RADIAL_LUMPED_RATE_MODEL_WITHOUT_PORES";
	}
};
} // namespace
 ...
 */
template <typename ConvDispOperator> class LumpedRateModelWithoutPores : public UnitOperationBase
{
public:
	...
	static const char* identifier() CADET_NOEXCEPT
	{
		return LumpedRateModelWithoutPoresName<ConvDispOperator>::identifier();
	}
