...
#ifndef LIBCADET_CSTRCONSTVOLUME_HPP_
#define LIBCADET_CSTRCONSTVOLUME_HPP_
 ...
 */
class CSTRConstVolumeModel : public UnitOperationBase
{
public:

	CSTRConstVolumeModel(UnitOpIdx unitOpIdx);
	virtual ~CSTRConstVolumeModel() CADET_NOEXCEPT;
...
#endif  // LIBCADET_CSTRCONSTVOLUME_HPP_
