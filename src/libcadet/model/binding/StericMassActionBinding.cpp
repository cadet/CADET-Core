...
public:
	...
	{
		return "NO_JACOBIAN_STERIC_MASS_ACTION";
	}

	CADET_BINDINGMODELBASE_BOILERPLATE

protected:
	const char* name() const CADET_NOEXCEPT override
	{
		return identity();
	}
	bool implementsAnalyticJacobian() const CADET_NOEXCEPT override
	{
		return false;
	}
...
namespace binding
{
void registerNoJacobianStericMassActionModel(
