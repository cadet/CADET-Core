...
namespace
{
template <typename Operator> struct LumpedRateModelWithPoresName
{
};

template <> struct LumpedRateModelWithPoresName<cadet::model::parts::AxialConvectionDispersionOperator>
{
...
template <> struct LumpedRateModelWithPoresName<cadet::model::parts::RadialConvectionDispersionOperator>
{
	static const char* identifier() CADET_NOEXCEPT
	{
		return "RADIAL_LUMPED_RATE_MODEL_WITH_PORES";
	}
};
} // namespace
 ...
 */
template <typename ConvDispOperator> class LumpedRateModelWithPores : public UnitOperationBase
{
public:
	...
	static const char* identifier() CADET_NOEXCEPT
	{
		return LumpedRateModelWithPoresName<ConvDispOperator>::identifier();
	}
...
protected:
	...
	template <typename Op_t> friend int schurComplementMultiplierLRMPores(void* userData, double const* x, double* z);
