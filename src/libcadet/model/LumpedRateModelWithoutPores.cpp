...
namespace
{
template <typename ConvDispOperator, typename StateType, typename ResidualType> class ConvOpJacobian
{
public:
	static inline void call(cadet::IModel* const model, ConvDispOperator& op, double t, unsigned int secIdx,
...
template <typename ConvDispOperator, typename ResidualType> class ConvOpJacobian<ConvDispOperator, double, ResidualType>
{
public:
	static inline void call(cadet::IModel* const model, ConvDispOperator& op, double t, unsigned int secIdx,
...
LumpedRateModelWithoutPores<ConvDispOperator>::LumpedRateModelWithoutPores(UnitOpIdx unitOpIdx)
...
template <typename ConvDispOperator> bool LumpedRateModelWithoutPores<ConvDispOperator>::usesAD() const CADET_NOEXCEPT
{
...
template <typename ConvDispOperator>
bool LumpedRateModelWithoutPores<ConvDispOperator>::configureModelDiscretization(IParameterProvider& paramProvider,
																				 const IConfigHelper& helper)
{
	...
	const bool transportSuccess =
		_convDispOp.configureModelDiscretization(paramProvider, helper, _disc.nComp, _disc.nCol, strideCell);
...
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::notifyDiscontinuousSectionTransition(
...
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::reportSolution(ISolutionRecorder& recorder,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::extractJacobianFromAD(active const* const adRes,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::checkAnalyticJacobianAgainstAd(active const* const adRes,
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::jacobian(const SimulationTime& simTime,
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::residual(const SimulationTime& simTime,
															const ConstSimulationState& simState, double* const res,
															util::ThreadLocalStorage& threadLocalMem)
{
	BENCH_SCOPE(_timerResidual);
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::residualWithJacobian(const SimulationTime& simTime,
...
int LumpedRateModelWithoutPores<ConvDispOperator>::residualImpl(double t, unsigned int secIdx, StateType const* const y,
																double const* const yDot, ResidualType* const res,
																util::ThreadLocalStorage& threadLocalMem)
{
	if (wantRes)
		ConvOpResidual<ConvDispOperator, StateType, ResidualType, ParamType, wantJac>::call(this, _convDispOp, t,
																							secIdx, y, yDot, res, _jac);
	else
		ConvOpJacobian<ConvDispOperator, StateType, ResidualType>::call(this, _convDispOp, t, secIdx, y, nullptr,
																		nullptr, _jac);
...
#endif
	{
		...
		if (wantRes)
			parts::cell::residualKernel<StateType, ResidualType, ParamType, parts::cell::CellParameters,
										linalg::BandMatrix::RowIterator, wantJac, false, true>(
				t, secIdx, ColumnPosition{z, 0.0, 0.0}, localY, localYdot, localRes,
				_jac.row(col * idxr.strideColCell()), cellResParams, threadLocalMem.get());
		else
			parts::cell::residualKernel<StateType, ResidualType, ParamType, parts::cell::CellParameters,
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::residualSensFwdWithJacobian(const SimulationTime& simTime,
																			   const ConstSimulationState& simState,
																			   const AdJacobianParams& adJac,
																			   util::ThreadLocalStorage& threadLocalMem)
{
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::residualSensFwdAdOnly(const SimulationTime& simTime,
																		 const ConstSimulationState& simState,
																		 active* const adRes,
																		 util::ThreadLocalStorage& threadLocalMem)
{
...
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::residualSensFwdCombine(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::multiplyWithJacobian(const SimulationTime& simTime,
																		 const ConstSimulationState& simState,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::multiplyWithDerivativeJacobian(const SimulationTime& simTime,
																				   const ConstSimulationState& simState,
...
template <typename ConvDispOperator>
unsigned int LumpedRateModelWithoutPores<ConvDispOperator>::localOutletComponentIndex(unsigned int port) const
	CADET_NOEXCEPT
{
...
template <typename ConvDispOperator>
unsigned int LumpedRateModelWithoutPores<ConvDispOperator>::localInletComponentIndex(unsigned int port) const
	CADET_NOEXCEPT
{
	return 0;
}
...
template <typename ConvDispOperator>
unsigned int LumpedRateModelWithoutPores<ConvDispOperator>::localOutletComponentStride(unsigned int port) const
	CADET_NOEXCEPT
{
	return 1;
}
...
template <typename ConvDispOperator>
unsigned int LumpedRateModelWithoutPores<ConvDispOperator>::localInletComponentStride(unsigned int port) const
	CADET_NOEXCEPT
{
	return 1;
}
...
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::expandErrorTol(double const* errorSpec, unsigned int errorSpecSize,
																   double* expandOut)
{
 ...
 */
template <typename ConvDispOperator>
int LumpedRateModelWithoutPores<ConvDispOperator>::linearSolve(double t, double alpha, double outerTol,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::addTimeDerivativeToJacobianCell(
	linalg::FactorizableBandMatrix::RowIterator& jac, const Indexer& idxr, double alpha, double invBeta) const
{
	// Mobile phase
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::consistentInitialState(const SimulationTime& simTime,
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::consistentInitialTimeDerivative(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::leanConsistentInitialState(const SimulationTime& simTime,
																			   double* const vecStateY,
																			   const AdJacobianParams& adJac,
																			   double errorTol,
																			   util::ThreadLocalStorage& threadLocalMem)
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::leanConsistentInitialTimeDerivative(
	double t, double const* const vecStateY, double* const vecStateYdot, double* const res,
	util::ThreadLocalStorage& threadLocalMem)
{
	BENCH_SCOPE(_timerConsistentInit);
...
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::initializeSensitivityStates(
	const std::vector<double*>& vecSensY) const
{
	Indexer idxr(_disc);
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::consistentInitialSensitivity(
 ...
 */
template <typename ConvDispOperator>
void LumpedRateModelWithoutPores<ConvDispOperator>::leanConsistentInitialSensitivity(
	const SimulationTime& simTime, const ConstSimulationState& simState, std::vector<double*>& vecSensY,
	std::vector<double*>& vecSensYdot, active const* const adRes, util::ThreadLocalStorage& threadLocalMem)
{
	BENCH_SCOPE(_timerConsistentInit);
...
template <typename ConvDispOperator>
bool LumpedRateModelWithoutPores<ConvDispOperator>::setSensitiveParameter(const ParameterId& pId,
