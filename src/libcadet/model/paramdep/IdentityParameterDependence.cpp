...
public:
	...
	{
		return IdentityParameterStateDependence::identifier();
	}
...
public:
	...
	virtual const char* name() const CADET_NOEXCEPT
	{
		return IdentityParameterParameterDependence::identifier();
	}
...
{
	paramDeps[IdentityParameterParameterDependence::identifier()] = []() {
		return new IdentityParameterParameterDependence();
	};
