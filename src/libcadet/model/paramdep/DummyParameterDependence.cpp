...
public:
	...
	{
		return ConstantZeroParameterStateDependence::identifier();
	}
...
public:
	...
	virtual const char* name() const CADET_NOEXCEPT
	{
		return ConstantOneParameterStateDependence::identifier();
	}
...
public:
	...
	virtual const char* name() const CADET_NOEXCEPT
	{
		return ConstantZeroParameterParameterDependence::identifier();
	}
...
public:
	...
	virtual const char* name() const CADET_NOEXCEPT
	{
		return ConstantOneParameterParameterDependence::identifier();
	}
...
{
	paramDeps[ConstantOneParameterStateDependence::identifier()] = []() {
		return new ConstantOneParameterStateDependence();
	};
	paramDeps[ConstantZeroParameterStateDependence::identifier()] = []() {
		return new ConstantZeroParameterStateDependence();
	};
...
{
	paramDeps[ConstantOneParameterParameterDependence::identifier()] = []() {
		return new ConstantOneParameterParameterDependence();
	};
	paramDeps[ConstantZeroParameterParameterDependence::identifier()] = []() {
		return new ConstantZeroParameterParameterDependence();
	};
