 ...
 * @f[\begin{align}
   ...
   This allows a position-dependent scaling of the parameter across
   the radial domain. E.g., with @f$ \alpha = 1, \beta = 1, k = 1 @f$,
   the parameter linearly increases from @f$ p @f$ (at inner wall)
   to @f$ 2p @f$ (at outer wall).
 */
