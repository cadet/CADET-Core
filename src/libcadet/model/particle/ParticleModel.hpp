...
namespace cadet
{
	...
	namespace model
	{
		...
		struct columnPackingParameters
		{
			...
			CouplingQuadrature filmDiffQuad; //!< Rule for averaging the film diffusion coefficient onto this bulk point
		};
