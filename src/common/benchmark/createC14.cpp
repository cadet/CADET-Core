...
void printHelp()
{
    log::emit() << "Usage: createC14 <FILE>" << log::endl;
    ...
    log::emit() << "When called with no arguments, default file name is C14.h5." << log::endl;
...
{
    std::string fileName("C14.h5");  // default output filename
