function singleComponentLangmuirVelocity()
%SINGLECOMPONENTLANGMUIRVELOCITY Simple single component Langmuir simulation with section dependent velocity
%
...
%            See the license note at the end of the file.
    ...
    model.diffusionParticle         = [6.07e-11 6.8e-9];
    model.diffusionParticleSurface  = [0.0];
    model.interstitialVelocity      = [5.75e-4 2.9e-4];
    ...
    model.sectionTimes = [0.0 4000 10000];
    ...
    % Sec 2
    model.sectionConstant(1,2)  = 7.14e-3;  % component 1
