...
%            See the license note at the end of the file.
    ...
    model.filmDiffusion             = [6.9e-6 6.9e-6 6.9e-6 6.9e-6, ... % For comps in sec 1
                                       6.9e-7 6.9e-7 6.9e-7 6.9e-7, ... % For comps in sec 2
                                       6.9e-5 6.9e-5 6.9e-5 6.9e-5];    % For comps in sec 3

    model.diffusionParticle         = [7e-10 6.07e-11 6.07e-11 6.07e-11, ...  % For comps in sec 1
                                       2e-10 9.07e-11 9.07e-11 9.07e-11, ...  % For comps in sec 2
                                       4e-10 3.07e-11 3.07e-11 3.07e-11];     % For comps in sec 3
