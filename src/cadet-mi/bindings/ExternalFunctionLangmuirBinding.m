...
classdef ExternalFunctionLangmuirBinding < BindingModel
    %EXTERNALFUNCTIONLANGMUIRBINDING Represents the External Function Langmuir isotherm by providing its parameters and helper functions
    ...
    methods
        ...
        function obj = ExternalFunctionLangmuirBinding()
            %EXTERNALFUNCTIONLANGMUIRBINDING Constructs an ExternalFunctionLangmuir object
            obj.name = 'EXTERNAL_LANGMUIR';
    ...
    methods (Access = 'private')
        ...
        function addParameterGroup(obj, namePrefix, offset)
            ...
            for i = 1:4
                ...
                obj.parameters{offset + i} = BindingModel.createParameter(['EXTL_' name], name, true);
            end
        end
