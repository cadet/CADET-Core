...
*
* 
*  Minor contributions and adaptions made by Samuel Leweke in 2013.
*
*****************************************************************************/
...
class MultiSwitchArg : public SwitchArg
{
	protected:
		...
		/**
		 * The place where the parsed value is stored, if given.
		 */
		int* _storage;
	...
	public:
	    ...
	    /**
	     * Store the parsed value in the given pointer.
	     * \param ptr - Storage for the parsed value.
	     */
		MultiSwitchArg* storeIn(int* const ptr);
...
inline bool MultiSwitchArg::processArg(int *i, std::vector<std::string>& args)
{
	...
	if ( argMatches( args[*i] ))
	{
		...
		if (MultiSwitchArg::_storage)
			*MultiSwitchArg::_storage = _value;
...
MultiSwitchArg::reset()
{
	...
	if (MultiSwitchArg::_storage)
		*MultiSwitchArg::_storage = MultiSwitchArg::_default;
}

inline MultiSwitchArg* 
MultiSwitchArg::storeIn(int* const ptr)
{
	MultiSwitchArg::_storage = ptr;
