...
- The field ``USE_COLLOCATION_DG`` only exists for axial cylinder columns and defaults to $0$ which is expected to be slightly more performant in most settings.
