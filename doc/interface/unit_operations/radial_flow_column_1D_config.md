...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** string | **Range:** `RADIAL_COLUMN_MODEL_1D` | **Length:** 1 |
...
> Column length/height (optional if `VELOCITY_COEFF` is present, see Section [](#MUOPGRMflow)).
...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** string | **Range:** $\texttt{CYLINDER\_SHELL}, \texttt{WEDGE}$ | **Length:** 1 |
...
> Interstitial velocity coefficient of the mobile phase (optional `COL_LENGTH` is present, see Section [](#MUOPGRMflow)).
...
> Specifically, the velocity coefficient here is defined as $\frac{Q}{2 \pi L \varepsilon_c}$, for details see Section [](#MUOPGRMradialFlow).
>
...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** string | **Range:** $\{\texttt{FV}\}$ | **Length:** 1 |
