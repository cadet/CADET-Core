...
``CROSS_SECTION_AREA_INNER``
	...
	Cross section area of the inner column radius
...
``BED_LENGTH``
   ...
   Column length/height (optional, only triggers a geometry check against the specified cross sectional areas at the inlet and outlet).
