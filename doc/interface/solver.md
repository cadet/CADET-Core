...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** double | **Range:** $\geq 0$ | **Length:** Arbitrary |
...
> Values less than or equal $0$ are ignored (i.e., no timeout is applied).
>
> |   |   |   |
> | --- | --- | --- |
...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** double | **Range:** $\geq 0$ | **Length:** $\texttt{NSEC}+1$ |
...
> |   |   |   |
> | --- | --- | --- |
> | **Type:** int | **Range:** $\{0,1\}$ | **Length:** $\texttt{NSEC}-1$ |
