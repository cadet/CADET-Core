...
Some binding models have a variant that can use external sources as specified in `/input/model/external/<FFModelExternalSourceLinInterp>` (also see Section [](#dependence-on-external-function-bind) for more information, and Section [](#binding-model-feature) on which binding models support this feature).
...
(multiple-particle-types-binding)=
