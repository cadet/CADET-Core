(generalized-ion-exchange-model)=
...
For more information on model parameters required to define in CADET file format, see [](#generalized-ion-exchange-config).
