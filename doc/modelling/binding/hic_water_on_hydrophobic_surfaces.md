(hic-water-on-hydrophobic-surfaces-model)=
...
For more information on model parameters required to define in CADET file format, see [](#hic-water-on-hydrophobic-surfaces-config).
