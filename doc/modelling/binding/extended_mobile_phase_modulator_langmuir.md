(extended-mobile-phase-modulator-langmuir-model)=

# Extended Mobile Phase Modulator Langmuir

This model is an extension of the mobile phase modulator Langmuir model (see Section [](#multi-component-langmuir-model)), which allows linear binding of some selected components.
...
For more information on model parameters required to define in CADET file format, see [](#extended-mobile-phase-modulator-langmuir-config).
