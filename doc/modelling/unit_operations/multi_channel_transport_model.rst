...
- :math:`N_k` is the number of spatially parallel channels.
- :math:`N_c` is the number of species/components.
- :math:`A_l` is the cross-sectional area of channel :math:`l`.
- :math:`u_l` is the axial velocity in channel :math:`l`.
- :math:`D_{\text{ax},i,l}` is the axial dispersion coefficient for component :math:`i` in channel :math:`l`.
...
Molecules can be laterally exchanged between any pair of channels :math:`l` and :math:`k` using different exchange models (see Exchange Models section below).
