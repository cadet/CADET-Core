...
Since any terminal node in the network is a sink (see Section [](#networks)), outlet unit operations are not strictly necessary.
...
For information on model parameters see [](#outlet-config).
