...
\usetikzlibrary{arrows,shapes,intersections,patterns,decorations,chains}
...
%\include{docs/intro}
\include{docs/simulation}
\include{docs/models}
\include{docs/binding}
\include{docs/reaction}
