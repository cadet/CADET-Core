...
//TEST_CASE("GRM_DG LWE one vs two identical particle types match", "[GRM],[DG],[DG1D],[Simulation],[ParticleType],[todo]")
//{
...
//TEST_CASE("GRM_DG LWE separate identical particle types match", "[GRM],[DG],[DG1D],[Simulation],[ParticleType],[todo]")
//{
//	cadet::test::particle::testSeparateIdenticalParticleTypes("GENERAL_RATE_MODEL", "DG", 1e-15, 1e-15);
//}
//
//TEST_CASE("GRM_DG linear binding single particle matches particle distribution", "[GRM],[DG],[DG1D],[Simulation],[ParticleType],[todo]")
//{
//	cadet::test::particle::testLinearMixedParticleTypes("GENERAL_RATE_MODEL", "DG", 5e-8, 5e-5);
//}
//
//TEST_CASE("GRM_DG multiple particle types Jacobian analytic vs AD", "[GRM],[DG],[DG1D],[Jacobian],[AD],[ParticleType],[todo]")
//{
//	cadet::test::particle::testJacobianMixedParticleTypes("GENERAL_RATE_MODEL", "DG");
//}
//
//TEST_CASE("GRM_DG multiple particle types time derivative Jacobian vs FD", "[GRM],[DG],[DG1D],[UnitOp],[Residual],[Jacobian],[ParticleType],[todo]")
//{
//	cadet::test::particle::testTimeDerivativeJacobianMixedParticleTypesFD("GENERAL_RATE_MODEL", "DG", 1e-6, 0.0, 9e-4);
//}
//
//TEST_CASE("GRM_DG multiple spatially dependent particle types Jacobian analytic vs AD", "[GRM],[DG],[DG1D],[Jacobian],[AD],[ParticleType],[todo]")
//{
//	cadet::test::particle::testJacobianSpatiallyMixedParticleTypes("GENERAL_RATE_MODEL", "DG");
//}
//
//TEST_CASE("GRM_DG linear binding single particle matches spatially dependent particle distribution", "[GRM],[DG],[DG1D],[Simulation],[ParticleType],[todo]")
//{
