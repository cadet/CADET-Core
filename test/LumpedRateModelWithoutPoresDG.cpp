...
TEST_CASE("LRM_DG numerical Benchmark with parameter sensitivities for linear case", "[LRM],[DG],[Simulation],[Reference],[Sensitivity],[CI]") // todo CI flag: currently only runs locally but fails on server
{
...
TEST_CASE("LRM_DG numerical Benchmark with parameter sensitivities for SMA LWE case", "[LRM],[DG],[Simulation],[Reference],[Sensitivity],[CI]") // todo CI flag: currently only runs locally but fails on server
{
