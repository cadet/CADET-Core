...
public:
	...
	inline cadet::model::IParameterStateDependence& model()
	{
		return *_paramDep;
	}
	inline const cadet::model::IParameterStateDependence& model() const
	{
		return *_paramDep;
	}
...
private:
	ConfiguredParameterDependence(cadet::model::IParameterStateDependence* paramDep, unsigned int nComp,
