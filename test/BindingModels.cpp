...
CADET_BINDINGTEST_ALLBINDING_SINGLE("SPLINE", (1), (0.8,1.5), \
		R"json(
		 "ML_KKIN": [1.0,2.0],
		 "model_weights":{
		  "spline_input_parameters": {
		"C_VALS":[0.0,  0.0889539 ,  0.19498597,  0.32332848,  0.48139437,
         0.67979292,  0.93355846,  1.26274402,  1.68950854,  2.22742619,
         2.86791504,  3.58297752,  4.34334371,  5.12904589,  5.92878511,
         6.73651158,  7.54896312,  8.36432471,  9.18154707, 10.0],
		"Q_VALS":[0.0 , 0.8168748 , 1.63170088, 2.4432972 , 3.24960308,
        4.04688525, 4.82818845, 5.58058715, 6.28184857, 6.90155579,
        7.4146278 , 7.81801243, 8.12851268, 8.36842468, 8.55674554,
        8.70742777, 8.8302675 , 8.93211734, 9.01783099, 9.09090909]}
			}
		)json", \
		1e-10, 1e-10);
...
//		1e-10, 1e-10);
//=======
//CADET_BINDINGTEST_ALLBINDING_SINGLE("FREUNDLICH_LDF", (1), (0.8, 1.5), \
//	R"json(
//		 "FLDF_KKIN": [1.0,10.0],
//		"FLDF_KF":[1.0,2.0],
//		"FLDF_N":[0.2,0.5]
