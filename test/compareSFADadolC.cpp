...
// g++-4.8 -I../ThirdParty/ADOL-C/include -I../src/libcadet -std=c++0x -o compareSFADadolC compareSFADadolC.cpp
...
typedef sfad::Fwd<double, sfad::HeapStorage> FwdAD;
...
template<typename T> struct testLog10 { T operator()(const T &a) const { return log10(a); } static const char* name() { return "testLog10"; } };
