...
``BLAS_UNDERSCORE_SUFFIX``
  ``TRUE`` if BLAS function names require an underscore as suffix
...
# Added support for CLAPACK and determines whether underscores are required
...
macro(CHECK_BLAS_LIBRARIES LIBRARIES UNDERSCORE_SUFFIX _prefix _name _flags _list _threadlibs _addlibdir _subdirs)
  ...
  # UNDERSCORE_SUFFIX indicates whether the functions have an underscore suffix
  # or not.
  ...
  if(_libraries_work)
    ...
    if(CMAKE_Fortran_COMPILER_LOADED)
      ...
      # Check whether underscore suffix is required in function name
      if (${${_prefix}${_combined_name}_WORKS})
        set(${UNDERSCORE_SUFFIX} TRUE)
      else()
        unset(${_prefix}${_combined_name}_WORKS CACHE)
        check_function_exists("${_name}" ${_prefix}${_combined_name}_WORKS)

        if (${${_prefix}${_combined_name}_WORKS})
          set(${UNDERSCORE_SUFFIX} FALSE)
        endif()
      endif()
    endif()
...
# BLAS library packaged with CLAPACK?
if (BLA_VENDOR STREQUAL "CLAPACK" OR BLA_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    check_blas_libraries(
      F2C_LIBRARIES
      BLAS_UNDERSCORE_SUFFIX
    ...
    if (F2C_LIBRARIES)
      ...
      list(APPEND BLAS_LIBRARIES ${F2C_LIBRARIES})
    else()
      check_blas_libraries(
        BLAS_LIBRARIES
        BLAS_UNDERSCORE_SUFFIX
